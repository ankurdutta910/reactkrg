...
import event2 from "../Assets/img/19thjanevent.jpg";
        ...
        <div className="container">
          ...
          <div className="col-md-3">
              <div className="bg-light rounded overflow-hidden">
                <img className="img-fluid w-100" src={event2} alt="" />
                <div className="p-3 text-center">
                  <a className="h4 d-block mb-2">Unveiling of a Sports Car & Bike</a>

                  <a className="h6 d-block">19th January 2025</a>
                </div>
              </div>
            </div>
