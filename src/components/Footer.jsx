          ...
          <div className="row g-5">
            ...
            <div className="col-lg-3 col-md-6">
              ...
              <div className="d-flex flex-column justify-content-start">
                ...
                <Link className="text-light mb-2" to="/login">
            ...
            <div className="col-lg-3 col-md-6">
              ...
              <div className="d-flex">
                <a
                  ...
                  href="https://www.facebook.com/share/1BJdj18Sq5/"
                  target="_blank"
                >
                ...
                <a
                  className="btn btn-lg btn-primary btn-lg-square rounded-circle me-2"
                  href="https://www.instagram.com/official_krg_riders?igsh=MWtxNXVyOG1tenJpdQ=="
                  target="_blank"
                >
                ...
                <a
                  ...
                  href="http://www.linkedin.com/in/kayirider-group"
                  target="_blank"
                >
